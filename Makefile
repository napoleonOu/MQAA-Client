...
BASE_DIR	=./src
SRC		=src/date.cpp src/loop.cpp src/tcpClient.cpp src/tcpServer.cpp src/tcpServerDispatcher.cpp src/tcpSession.cpp src/tcpSocket.cpp src/timer.cpp Client-Main.cpp ./MQAA/tcpClient.cpp ./MQAA/MQAA.pb.cpp
